...
class GenerationSixCalculator(BaseCaptureCalculator):
    generation = 6
    ...
    def calculate(self, capture_input: CaptureInput) -> CaptureResult:
        ...
        ball_effect = cast(
            ...
            get_ball_rules(self.generation).resolve(
                BallContext(
                    ...
                    wild_pokemon_base_speed=capture_input.wild_pokemon_base_speed,
        ...
        if capture_value > 255:
            ...
            probability = (shake_check_value / 65536) ** 4
    ...
    def _calculate_capture_value(
        *,
        ...
        return max(1, int(base_value * status_multiplier))
